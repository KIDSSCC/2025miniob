...
PipelineCachePhysicalOperator::PipelineCachePhysicalOperator()
{
}

RC PipelineCachePhysicalOperator::open(Trx *trx)
{
  if (children_.empty()) {
    return RC::SUCCESS;
  }
...
RC PipelineCachePhysicalOperator::next()
{
...
Tuple *PipelineCachePhysicalOperator::current_tuple()
{
  if (curr_tuple_ != all_tuple.end()) {
...
RC PipelineCachePhysicalOperator::tuple_schema(TupleSchema &schema) const
{
